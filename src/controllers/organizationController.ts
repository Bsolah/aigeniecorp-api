...
export const updateOrganization = async (
  ...
  try {
    const { location, size, industry, website, regNo } = req.body;
    const userOrg = await Organization.findByIdAndUpdate(req.params?.id, {location, size, industry, website, regNo}, {new: true})
